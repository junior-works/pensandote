...
export async function solicitarCheckin(circleId, targetUserId) {
    ...
    // El aviso al adulto mayor NO se manda desde acá: lo dispara el
    // trigger checkin_solicitud_push_aviso de la migración 0020, que ya
    // avisa al destinatario ("X quiere saber cómo estás"). Mandarlo
    // también desde el front le llegaban DOS notificaciones por el
    // mismo pedido, con tags distintos, así que ninguna reemplazaba a
    // la otra.
    return data;
}
